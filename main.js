...
// OBJETOS CON PELÍCULAS, LAS CATEGORÍAS  SON UN ARRAY
...
//Switch según la respuesta del tipo de búsqueda
switch(respuesta){
    case 1 : 
        do{ // pido que ingrese el año de la película
        ...
        // muestro las películas en las que el año coincida con lo que el usuario ingresó
    ...
    case 2 :
        ...
        // si se encuentra en el array de categorías lo que el usuario ingresó, que se muestre la frase con info del objeto.
        ...
        break
    case 3 :
        do{ // pido que ingrese 1 o 2 dependiendo la duracion de la pelicula
        ...
        switch(respuestaSwitch){
            case 1 : // si ingresa uno, muestro las peliculas que duren menos de 120 minutos
    ...
    case 4 :
        ...
        // muestro la info de las películas que coincidan con la respuesta del usuario 
